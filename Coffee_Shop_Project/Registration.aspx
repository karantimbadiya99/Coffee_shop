<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="Registration.aspx.cs" Inherits="Coffee_Shop_Project.Registration" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    11<!-- Page Header Start --><div class="container-fluid page-header mb-5 position-relative overlay-bottom">
    ...
    <body>
        ...
        <div class="container">
            <form>
                ...
                <div>
                    <!-- Favorite Coffee -->
                    <asp:Label ID="lblFavoriteCoffee" runat="server" Text="Favorite Coffee:" Font-Bold="True" Font-Size="Large"></asp:Label>
                    <asp:DropDownList ID="ddlFavoriteCoffee" runat="server" CssClass="form-select">
                        <asp:ListItem Value="">--Select Coffee--</asp:ListItem>
                        <asp:ListItem Value="Espresso">Espresso</asp:ListItem>
                        <asp:ListItem Value="Latte">Latte</asp:ListItem>
                        <asp:ListItem Value="Cappuccino">Cappuccino</asp:ListItem>
                        <asp:ListItem Value="Americano">Americano</asp:ListItem>
                        <asp:ListItem Value="Mocha">Mocha</asp:ListItem>
                        <asp:ListItem Value="Cold Brew">Cold Brew</asp:ListItem>
                    </asp:DropDownList>
                </div>

                <div>
                    <!-- Preferences -->
                    <asp:Label ID="lblPreferences" runat="server" Text="Select Your Preferences:" Font-Bold="True" Font-Size="Large"></asp:Label>
                    <asp:CheckBoxList ID="cbPreferences" runat="server" RepeatDirection="Horizontal" CssClass="form-check">
                        <asp:ListItem Value="Promos">Promotional Offers</asp:ListItem>
                        <asp:ListItem Value="NewProducts">New Products</asp:ListItem>
                        <asp:ListItem Value="Exclusive">Exclusive Deals</asp:ListItem>
                    </asp:CheckBoxList>
                </div>
