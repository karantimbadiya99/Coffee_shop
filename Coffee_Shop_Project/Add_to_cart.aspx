<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" EnableEventValidation="false"  CodeBehind="Add_to_cart.aspx.cs" Inherits="Coffee_Shop_Project.Add_to_cart" %>
        ...
        <p>
            ...
            <div class="cart-container">
                ...
                <asp:DataList ID="Cart_List" runat="server" RepeatDirection="Horizontal" CssClass="cart-list"
                    ...
                    <ItemTemplate>
                        <div class="cart-item">
                            <asp:Image ID="Image1" runat="server" Height="200" Width="200" CssClass="product-image" ImageUrl='<%# Eval("image") %>' />
